...
ALL_GOALS = ['clean_simple',
             ...
             'slice_and_heat_and_clean',
             'cool_and_slice_and_clean',
             'clean_and_stack_and_place',
             'cool_and_stack_and_place',
             'heat_and_stack_and_place',
             'clean_then_cool',
             'clean_then_heat',
             'clean_then_place',
             'clean_then_slice',
...
######################## Train Split ############################
# Counter({'slice': 35, 'clean': 33, 'heat': 28, 'place': 25, 'cool': 11, 'pick': 1})
train_split = ['slice_then_heat_then_clean',
               'slice_then_place',
               'slice_then_cool',
               'slice_and_clean_and_place',
               'slice_then_clean',
...
######################### Test Splits #############################
# (cool, clean), (heat, slice, place)
# Counter({'cool': 22, 'clean': 22, 'slice': 18, 'place': 11, 'heat': 5})
sub_goal_composition_split = ['clean_then_cool',
                              'slice_and_heat_then_place',
                              'clean_then_slice_then_cool',
                              'clean_and_slice_then_cool',
                              'cool_then_clean_then_place',
...
verb_noun_composition_split = ['clean_simple',
                               'heat_simple',
                               'place_simple',
                               'slice_simple',
                               'slice_and_heat',
...
context_verb_noun_composition_split = ['heat_simple',
                                       'cool_simple',
                                       'place_simple',
                                       'slice_then_heat_then_clean',
                                       'slice_then_place',
...
abstraction_split = list(set(train_split) - {'place_simple', 'pick_simple', 'heat_simple',
                                             'cool_simple', 'slice_simple', 'clean_simple'})

assert len(set(sub_goal_composition_split).intersection(set(train_split))) == 0, \
    "sub-goal-composition split and train split should not have overlapping goals/tasks"
assert len(set(context_verb_noun_composition_split).intersection(set(sub_goal_composition_split))) == 0, \
    "sub-goal-composition split and context-verb-noun-composition split should not have overlapping goals/tasks"
assert len(set(verb_noun_composition_split).intersection(set(sub_goal_composition_split))) == 0, \
    "sub-goal-composition split and verb-noun-composition split should not have overlapping goals/tasks"
###########################################################
...
# env.last_event.instance_detections2D
# FPS
VIDEO_FRAME_RATE = 5
