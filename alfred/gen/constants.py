...
novel_tasks_split = ['clean_then_cool',
                     'slice_and_heat_then_place',
                     'clean_then_slice_then_cool',
                     'clean_and_slice_then_cool',
                     'cool_then_clean_then_place',
                     ...
                     'clean_then_cool_then_place',
                     'clean_and_cool_then_slice']
novel_steps_split = ['clean_simple',
                     'heat_simple',
                     'place_simple',
                     'slice_simple',
                     'slice_and_heat',
...
assert len(set(novel_tasks_split).intersection(set(train_split))) == 0, \
    "novel-tasks-composition split and train split should not have overlapping goals/tasks"
# assert len(set(context_verb_noun_composition_split).intersection(set(novel_tasks_split))) == 0, \
#     "sub-goal-composition split and context-verb-noun-composition split should not have overlapping goals/tasks"
assert len(set(novel_steps_split).intersection(set(novel_tasks_split))) == 0, \
    "novel-tasks-composition split and novel-steps-composition split should not have overlapping goals/tasks"
###########################################################
