...
class TaskGameState(PlannedGameState):
    ...
    def __init__(self, env, domain, domain_path, seed=None, action_space=None):
        ...
        super(TaskGameState, self).__init__(env, domain, domain_path, seed, action_space)
    ...
    def setup_problem(self, abstraction=None, seed=None, info=None, scene=None, objs=None):
        ...
        toggle_objects = [o for o in self.env.last_event.metadata['objects']
                          if o['toggleable'] and o['objectType'] in constants.VAL_ACTION_OBJECTS["Toggleable"]]
        ...
        if "toggle" in constants.pddl_goal_type:
