...
do
  ...
  do
    ...
    echo $run_id " | " $split
    echo "===================================================="
    CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 socratic_test.py --num_workers 2 --split_type $split --batch_size 256 --sample_rate 2 --run_id $run_id
