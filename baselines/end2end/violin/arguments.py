...
def Arguments():
    parser = argparse.ArgumentParser(description="violin-baseline")
    ...
    parser.add_argument('--visual_feature_extractor', type=str, default='i3d', choices=['i3d', 's3d','clip','resnet'],
                        help='i3d or resnet features for video (premise)')
    parser.add_argument('--text_feature_extractor', type=str, default='glove', choices=['bert', 'glove','clip'],
    ...
    parser.add_argument('--pretrain_path', type=str, default='s3d/S3D_kinetics400.pt',
                        help='pretrain_path')
    parser.add_argument('--howto', action='store_true', help='to use bidaf attention ?')
