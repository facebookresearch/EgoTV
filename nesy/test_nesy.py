# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 29500 test_nesy.py --num_workers 4 --split_type 'sub_goal_composition' --batch_size 64 --sample_rate 2 --run_id 1 --fp_seg 8
import os
import sys
